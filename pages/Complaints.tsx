      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2" ref={assignRef}>
          {job.assignedMechanicId ? (
            <div
              className={`relative flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-xs font-semibold cursor-pointer select-none ${mechanicColor(job.assignedMechanicId)}`}
